...
## What do you need?
  ...
  - Parts
    ...
    - or grab [Required Parts](./RequiredParts.mdx#required-parts) and pick your own [Optional Parts](S2MiniQuickStart/OptionalParts.mdx#optional-parts)


## Putting it together

  - Setup the S2 Mini controller
    -   [S2 Mini Controller Install Quick Start](./CircuitPythonSetup.mdx))
