...
- Install CircuitPython and the TerrainTronics bundle on your controller.
  ...
  - for now look at details for your controller under [Supported Controllers](../Controllers/SupportedControllers.mdx) and then [Initial Controler Setup](InitialControllerSetup.mdx)
